...
static const char *fonts[]          = { "hack:size=13","fontawesome:size=12" };
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  }, //col_gray5
};
...
static const char *editor[] = { "xfce4-terminal", "-e", "vim" , NULL };
static const char *files[] = { "xfce4-terminal", "-e", "mc" , NULL };
